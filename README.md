...
```shell
npm i github:your_github_username/logofx-aurelia-mvvm-plugin
# or if you use bitbucket
npm i bitbucket:your_github_username/logofx-aurelia-mvvm-plugin
# or if you use gitlab
npm i gitlab:your_github_username/logofx-aurelia-mvvm-plugin
# or plain url
npm i https:/github.com/your_github_username/logofx-aurelia-mvvm-plugin.git
```
